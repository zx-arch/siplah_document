...
@section('container')
    ...
    @include('documents.components.navbar')
                                    ...
                                    <tr>
                                        ...
                                        <form action="{{url('pembatalan_transaksi/download_document_upload')}}" method="post">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('pembatalan_transaksi/delete/'.$get->user. '/' . $get->kode_document)}}" class="btn btn-danger"><i class='bx bx-trash'></i></a>
                                            </td>
                                        </form>
                                    </tr>
                                @endforeach
        ...
        <!-- Tambahkan bagian ini di bagian bawah halaman Anda -->
        <script>
